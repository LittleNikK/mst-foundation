...
const researchAreas = [
  {
    ...
    summary:
      "Byzantine fault tolerance, block finality models, and censorship-resistant validator ordering.",
    topics: [
      "Sub-second probabilistic finality protocols",
      "Proposer-builder separation (PBS) & MEV mitigation",
      "Long-range attack defense in proof-of-stake architectures",
    ],
    icon: Cpu,
    accent: "#2563EB",
    badgeBg: "#EFF6FF",
  ...
  },
  {
    ...
    title: "Scalability",
    summary:
      "Stateless execution, state compression, and cryptographic proofs for horizontal network throughput.",
    topics: [
      "Zero-knowledge state verification algorithms",
      "History expiry and light-client sync optimizations",
      "Cross-domain interoperability & atomic settlement",
    ],
    icon: Layers,
    accent: "#4F46E5",
    badgeBg: "#EEF2FF",
  ...
  },
  {
    ...
    summary:
      "Constitutional bylaws, anti-capture assembly structures, and non-plutocratic coordination models.",
    topics: [
      "Quadratic voting and reputation-weighted governance",
      "Separation of powers between maintainers and treasury",
      "Automated treasury circuit-breakers & dispute arbitration",
    ],
    icon: Scale,
    accent: "#B88728",
    badgeBg: "#FEF9EE",
  ...
  },
  {
    ...
    summary:
      "Quantitative frameworks measuring validator dispersion, client diversity, and network resilience.",
    topics: [
      "Empirical Nakamoto coefficient calculations",
      "Geographic ISP and data-center cluster analysis",
      "Economic attack vector simulation & resilience scoring",
    ],
    icon: Activity,
    accent: "#16A34A",
    badgeBg: "#F0FDF4",
      ...
      <main className="flex-1 w-full pt-24 sm:pt-28 lg:pt-32 pb-16 sm:pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <span className="text-[#0D1117] font-semibold">Research</span>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10 max-w-4xl">
              ...
              >
                Independent research funded and published by SmartAngelos, for the benefit
                of the wider MST community.
              </p>
            </div>
          </motion.section>
          ...
          >
            ...
            <div>
              <p className="text-[11.5px] font-bold uppercase tracking-wider text-[#8E6317] font-[var(--font-outfit)] mb-1">
                Publication Status · No Published Research Yet
              </p>
              <p className="text-[13.5px] sm:text-[14px] leading-[1.65] text-[#5A4112] font-normal">
                <strong>Note:</strong> The Foundation is currently reviewing fellowship
                applications for our first research cohort. All future working papers,
                benchmarks, and security audits will be published openly under permissive
                open-access licenses.
              </p>
            </div>
          </motion.div>

          {/* ── Research Areas We're Prioritizing ── */}
          <section className="mb-14 sm:mb-20">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-start mb-8 sm:mb-10">
              ...
              <div className="lg:col-span-5 flex items-center lg:pt-8">
                <p className="text-[14px] sm:text-[15px] leading-[1.68] text-[#373E4A]">
                  Targeted funding allocated toward core protocol bottlenecks, formal verification,
                  and foundational infrastructure resilience.
                </p>
              </div>
            </div>

            {/* 4 Research Priority Cards */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 lg:gap-6 items-stretch mb-5">
              {researchAreas.map((area, idx) => {
                ...
                return (
                  <motion.div
                    ...
                    className="group relative flex flex-col justify-between h-full rounded-[22px] border border-slate-200/90 bg-white p-6 sm:p-8 overflow-hidden transition-all duration-300 hover:-translate-y-1.5 hover:border-slate-300/90 hover:shadow-[0_20px_38px_-8px_rgba(15,23,42,0.12),0_4px_12px_-2px_rgba(15,23,42,0.04)]"
                    style={{
                      background: `radial-gradient(circle at 90% 10%, ${area.glowColor} 0%, transparent 60%), #FFFFFF`,
                    }}
                  >
                    ...
                    <div>
                      ...
                      <div className="flex items-center justify-between gap-3 mb-5">
                        <div
                          ...
                          style={{
                            background: area.badgeBg,
                            border: `1px solid ${area.badgeBorder}`,
                            color: area.badgeText,
                          }}
                        >
                      ...
                      <h3
                        ...
                        className="text-xl sm:text-[22px] font-bold text-[#0D1117] leading-[1.25] tracking-tight mb-2.5 group-hover:text-[#090D14]"
                      >
                        {area.title}
                      </h3>
                      ...
                      <ul className="space-y-2 mb-4">
                        {area.topics.map((t) => (
                          <li key={t} className="flex items-start gap-2 text-[12.5px] sm:text-[13px] text-[#475569] leading-relaxed">
            ...
            {/* Note on Illustrative Priorities */}
            <p className="text-[12.5px] text-[#64748B] italic text-center">
              Note: Confirm these match SmartAngelos’ actual research priorities before publishing — currently illustrative.
            </p>
          </section>
          ...
          <section className="mb-14 sm:mb-20">
            <div className="rounded-[28px] sm:rounded-[36px] bg-white border border-slate-200/90 p-7 sm:p-10 lg:p-12 shadow-[0_16px_40px_rgba(15,23,42,0.06)]">
              ...
              <div className="py-12 px-6 rounded-[22px] bg-[#FAF7F2] border border-amber-200/70 text-center flex flex-col items-center justify-center max-w-xl mx-auto">
                ...
                <p className="text-[13.5px] sm:text-[14px] leading-relaxed text-[#5A4112] mb-6">
                  Working papers from our inaugural research fellowship cohort are currently
                  undergoing formal review. Preprints will be archived here and permanently
                  hashed to the network.
                </p>
                ...
                >
                  <span>Submit a Research Proposal</span>
          ...
          <section className="relative rounded-[24px] sm:rounded-[32px] overflow-hidden bg-[#0D1117] text-white p-8 sm:p-12 lg:p-14 shadow-xl">
            ...
            <div className="relative z-10 max-w-3xl">
              <p className="text-[11px] sm:text-[12px] uppercase tracking-[0.24em] font-semibold text-[#F5BA13] select-none font-[var(--font-outfit)] mb-3">
                Academic &amp; Independent Fellowships
              </p>
              <h2
                style={{ fontFamily: "var(--font-jost), 'Jost', sans-serif" }}
                className="text-2xl sm:text-4xl lg:text-[42px] font-bold tracking-tight text-white leading-tight mb-4"
              >
                Conduct funded research with SmartAngelos.
              </h2>
              <p className="text-[14.5px] sm:text-[15.5px] leading-relaxed text-slate-300 mb-8 max-w-2xl font-normal">
                We provide non-dilutive grant funding, computing resources, and maintainer
                collaboration for researchers tackling foundational questions in decentralized
                systems.
              </p>
